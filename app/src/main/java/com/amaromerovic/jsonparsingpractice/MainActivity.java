...
import com.amaromerovic.jsonparsingpractice.data.RequestQueueSingleton;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void displayUser() {
        ...
        mainBinding.phone.setText(getResources().getString(R.string.phone) + "\n" + user.getPhone());
        mainBinding.website.setText(getResources().getString(R.string.website) + "\n" + user.getWebsite());
